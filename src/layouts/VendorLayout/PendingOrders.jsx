...
const PendingOrders = () => {
    ...
    useEffect(() => {
        const fetchPendingOrders = async () => {
            try {
                ...
                const filteredOrders = response.data.filter(order => order.status === 'Processing');
    ...
    const handleAccept = async () => {
        try {
            ...
            if (response.data.success) {
                // You can update the pendingOrders state or refresh the orders after acceptance
                setPendingOrders((prev) => prev.filter(order => order.id !== selectedOrderId));
                handleClose();
            } else {
